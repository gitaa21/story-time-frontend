        ...
        <div class="flex items-center mr-20 ml-20 mt-5 gap-4">
          ...
          <div class="dropdown">
            ...
            <div v-show="isSortDropdownOpen" class="dropdown-content">
              <h5
                class="p-3 hover:border-l-4 hover:border-gray-asparagus transition duration-300 ease-in-out cursor-pointer"
                @click="selectSortOption('Newest')">
                Newest</h5>
              <h5
                class="p-3 hover:border-l-4 hover:border-gray-asparagus transition duration-300 ease-in-out cursor-pointer"
                @click="selectSortOption('Popular')">Popular</h5>
              <h5
                class="p-3 hover:border-l-4 hover:border-gray-asparagus transition duration-300 ease-in-out cursor-pointer"
                @click="selectSortOption('A-Z')">A -
                Z</h5>
              <h5
                class="p-3 hover:border-l-4 hover:border-gray-asparagus transition duration-300 ease-in-out cursor-pointer"
                @click="selectSortOption('Z-A')">Z -
                A</h5>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-center mt-5 gap-4">
          ...
          <div class="dropdown">
            ...
            <div v-show="isCategoryDropdownOpen" class="dropdown-content">
              ...
              <h5
                class="p-3 hover:border-l-4 cursor-pointer hover:border-gray-asparagus transition duration-300 ease-in-out "
                v-for="category in categories" :key="category.id" @click="selectCategory(category)">
                {{ category.name }}
              </h5>
            </div>
          </div>
